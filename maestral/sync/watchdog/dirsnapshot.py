...
class DirectorySnapshotDiff(object):
    ...
    def __init__(self, ref, snapshot):
        ...
        self._change_list = collections.OrderedDict(sorted(_change_list.items()))
    ...
    def change_list(self):
        """List of files that were changes, ordered by mtime."""
...
class DirectorySnapshot(object):
    ...
    :param listdir:
        Use custom listdir function. For details see ``os.scandir`` if
        available, else ``os.listdir``.
    """
