...
a = Entrypoint(
    ...
    datas= [
        ...
        (pkgr.resource_filename('maestral_qt', 'resources/tray-icons-png/*.png'), 'maestral_qt/resources/tray-icons-png'),
        (pkgr.resource_filename('maestral_qt', 'resources/*'), 'maestral_qt/resources'),
